...
public class StickerView: UIView {
    ...
    public  init(contentView: UIView) {
        ...
        self.addGestureRecognizer(self.rotateGestureContent)
        ...
        self.setPosition(.topRight, forHandler: .flip)
    ...
    private lazy var flipImageView:UIImageView = {
        ...
        flipImageView.backgroundColor = UIColor.white
    ...
    private lazy var rotateGestureContent = {
        return UIRotationGestureRecognizer(target: self, action: #selector(handleRotateGestureContent(_:)))
    }()
    ...
    @objc
    func handleRotateGestureContent(_ recognizer: UIRotationGestureRecognizer) {
